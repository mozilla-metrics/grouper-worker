package org.mozilla.grouper.hbase.keys;
...
public abstract class Keys {
  ...
  public
  String documentPrefix(CollectionRef col) {
    return document(col.namespace(), col.key(), null);
  }


  public
  String clustersPrefix(String ns, String ck, long rebuildTS) {
  ...
  public final
  String key(ClusterRef ref) {
    CollectionRef owner = ref.ownerRef();
    return cluster(owner.namespace(), owner.key(),
                   ref.rebuildTs(), ref.label());
  }
